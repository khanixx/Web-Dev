...
export const products: Product[] = [
  ...
  // ==========================================
  // КАТЕГОРИЯ 2: Аудио и Красота (categoryId: 2)
  // Твои товары: Sony, Dyson
  // ==========================================
  {
    id: 2,
    categoryId: 2,
  ...
  // ==========================================
  // КАТЕГОРИЯ 3: Мемы и Разное (categoryId: 3)
  // Твои товары: Nurlan Saburov, Shneine pepe, wehehe
  // ==========================================
  {
    id: 7,
    categoryId: 3,
  ...
  // ==========================================
  // КАТЕГОРИЯ 4: Канцелярия (categoryId: 4)
  // Твои товары: Karandash
  // ==========================================
  {
    id: 10,
    categoryId: 4,
